...
for a1 in range(animal_num):
    for a2 in range(a1 + 1, animal_num):
        # If there are 2 animals that have the same common trait
        # Elsie can ask about those traits that are common
        # Basically max_yes = # common traits + 1
        max_yes = len(animals[a1].intersection(animals[a2])) + 1
